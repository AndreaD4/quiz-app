...
/home/pi/.rbenv/shims/bundle install
...
echo '-- migrate'
RAILS_ENV=production /home/pi/.rbenv/shims/bundle exec rake db:migrate
echo '-- js:routes'
RAILS_ENV=production /home/pi/.rbenv/shims/bundle exec rake js:routes
echo '-- assets:precompile'
RAILS_ENV=production /home/pi/.rbenv/shims/bundle exec rake assets:precompile
...
nohup /home/pi/.rbenv/shims/bundle exec rake jobs:work </dev/null &>/dev/null &
...
echo '-- Restart nginx'
echo raspberry | sudo -S service nginx restart
