(() => {
  ...
  var require_feather_min = __commonJS({
    "../../node_modules/feather-icons/dist/feather.min.js"(exports, module) {
      !function(e, n) {
        ...
        return function(e) {
          ...
          e.exports = function(e2, n2) {
            if (!t(e2))
              return e2;
            var i2, l;
            if (n2 && typeof (i2 = e2.toString) == "function" && !t(l = i2.call(e2)))
              return l;
            if (typeof (i2 = e2.valueOf) == "function" && !t(l = i2.call(e2)))
              return l;
            if (!n2 && typeof (i2 = e2.toString) == "function" && !t(l = i2.call(e2)))
              return l;
          ...
          !function() {
            ...
            var i2 = function() {
              ...
              function n2(e3, n3) {
                for (var i4 = n3.length, t3 = 0; t3 < i4; ++t3)
                  l(e3, n3[t3]);
              }
              ...
              function l(e3, l2) {
                if (l2) {
                  ...
                  r === "string" ? function(e4, n3) {
                    for (var i4 = n3.split(t2), l3 = i4.length, r2 = 0; r2 < l3; ++r2)
                      e4[i4[r2]] = true;
                  }(e3, l2) : Array.isArray(l2) ? n2(e3, l2) : r === "object" ? function(e4, n3) {
                    for (var t3 in n3)
                      i3.call(n3, t3) && (e4[t3] = !!n3[t3]);
              ...
              return function() {
                for (var i4 = arguments.length, t3 = Array(i4), l2 = 0; l2 < i4; l2++)
                  t3[l2] = arguments[l2];
                var r = new e2();
                n2(r, t3);
                var o = [];
            ...
            e !== void 0 && e.exports ? e.exports = i2 : (t = function() {
              return i2;
          ...
          e.exports = function(e2, n2) {
            ...
            for (i2 in r2)
              !t(o, i2) && t(r2, i2) && p.push(i2);
            for (; n2.length > c; )
              t(r2, i2 = n2[c++]) && (~a(p, i2) || p.push(i2));
            return p;
          };
        }, function(e, n, i) {
          ...
          l("inspectSource", function(e2) {
            ...
            typeof i2 == "function" && (typeof n2 != "string" || o(i2, "name") || r(i2, "name", n2), h(i2).source = x.join(typeof n2 == "string" ? n2 : "")), e2 !== t ? (c2 ? !y2 && e2[n2] && (p2 = true) : delete e2[n2], p2 ? e2[n2] = i2 : r(e2, n2, i2)) : p2 ? e2[n2] = i2 : a(n2, i2);
          ...
          e.exports = function(e2, n2) {
            ...
            if (i2 = d ? t : f ? t[u] || a(u, {}) : (t[u] || {}).prototype)
              for (y in n2) {
                if (x = n2[y], h = e2.noTargetGet ? (s = l(i2, y)) && s.value : i2[y], !p(d ? y : u + (f ? "." : "#") + y, e2.forced) && h !== void 0) {
          ...
          e.exports = function(e2) {
            return "Symbol(".concat(e2 === void 0 ? "" : e2, ")_", (++i + t).toString(36));
          };
        }, function(e, n, i) {
          ...
          n.default = function() {
            ...
            Array.from(n2).forEach(function(n3) {
              return function(e3) {
                var n4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i2 = function(e4) {
          ...
          var t = i(30), l = i(2)("toStringTag"), r = t(function() {
            return arguments;
          }()) == "Arguments";
          e.exports = function(e2) {
            var n2, i2, o;
            return e2 === void 0 ? "Undefined" : e2 === null ? "Null" : typeof (i2 = function(e3, n3) {
              try {
                return e3[n3];
              } catch (e4) {
              }
            }(n2 = Object(e2), l)) == "string" ? i2 : r ? t(n2) : (o = t(n2)) == "Object" && typeof n2.callee == "function" ? "Arguments" : o;
          };
        }, function(e, n, i) {
          ...
          e.exports = function(e2) {
            var n2, i2, y, h, x = l(e2), s = typeof this == "function" ? this : Array, u = arguments.length, d = u > 1 ? arguments[1] : void 0, f = d !== void 0, g = 0, v = p(x);
            if (f && (d = t(d, u > 2 ? arguments[2] : void 0, 2)), v == void 0 || s == Array && o(v))
              for (i2 = new s(n2 = a(x.length)); n2 > g; g++)
                c(i2, g, f ? d(x[g], g) : x[g]);
            else
              for (h = v.call(x), i2 = new s(); !(y = h.next()).done; g++)
                c(i2, g, f ? r(h, d, [y.value, g], true) : y.value);
          ...
          e.exports = t ? Object.defineProperties : function(e2, n2) {
            r(e2);
            for (var i2, t2 = o(n2), a = t2.length, c = 0; a > c; )
              l.f(e2, i2 = t2[c++], n2[i2]);
            return e2;
          };
        }, function(e, n, i) {
          var t = i(3), l = i(60), r = i(13), o = i(15), a = i(58), c = i(34), p = i(16)("IE_PROTO"), y = function() {
            ...
            for (n2.style.display = "none", a.appendChild(n2), n2.src = String("javascript:"), (e2 = n2.contentWindow.document).open(), e2.write("<script>document.F=Object<\/script>"), e2.close(), h = e2.F; i2--; )
              delete h.prototype[r[i2]];
            return h();
          };
          e.exports = Object.create || function(e2, n2) {
            var i2;
            return e2 !== null ? (y.prototype = t(e2), i2 = new y(), y.prototype = null, i2[p] = e2) : i2 = h(), n2 === void 0 ? i2 : l(i2, n2);
          }, o[p] = true;
        }, function(e, n, i) {
          var t = i(4);
          ...
          var t = i(4), l = /#|\.prototype\./, r = function(e2, n2) {
            var i2 = a[o(e2)];
            return i2 == p || i2 != c && (typeof n2 == "function" ? t(n2) : !!n2);
